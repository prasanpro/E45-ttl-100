...
//    memcpy ( type, rs.data.c_str(), sizeof(type) );
    ...
    if (typeStr=="ALRT"){
      ResponseStructContainer rsc = e32ttl.receiveMessage(sizeof(Control));
      struct Control control = *(Control*) rsc.data;
      Serial.println(control.control);
      //int alertBool = *(int*)(control.alert);
      //Serial.println(alertBool);
